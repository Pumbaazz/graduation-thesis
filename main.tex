...
\include{Appendix/nhanxetgiaovienhuongdan}

%\addcontentsline{toc}{chapter}{Nhận xét của giáo viên phản biện}
\include{Appendix/nhanxetgiaovienphanbien}

%\addcontentsline{toc}{chapter}{Đề cương đồ án tốt nghiệp}
...
\printbibliography[heading=subbibliography, title=Tài liệu tham khảo, resetnumbers=4] 
