...
\label{Chapter5}
\textit{Nội dung chương 5 sẽ tập trung giải thích về cách thức hoạt động của phần Back-end của hệ thống. Gồm các giai đoạn như sau:
\begin{itemize}
...
\begin{itemize}
	...
	\item Manual labelling law question
\end{itemize}
