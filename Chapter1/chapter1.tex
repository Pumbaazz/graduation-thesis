...
Đề tài hướng đến mục tiêu là xây dựng một hệ thống hỏi đáp tự động tiếng Việt cho một lĩnh vực cụ thể là về pháp luật Việt Nam. Bằng cách áp dụng công nghệ trí tuệ nhân tạo giúp nâng cao hiệu quả, tốc độ và sự chính xác trong câu trả lời mà hệ thống đưa ra. Với hướng tiếp cận xử lý ngôn ngữ tự nhiên, sử dụng các Pre-trained Model (mô hình tiền huấn luyện) để phân tích ngữ nghĩa của các câu hỏi và cho ra kết quả chính xác nhất thì việc xây dựng một hệ thống về hỏi đáp Pháp luật Việt Nam.

\pagebreak
\section{Nội dung của đồ án}

Đồ án có tổng cộng 6 chương với nội dung chính như sau:
...
\textbf{Chương 2:} Khảo sát hiện trạng
	Nội dung chương 2 là báo cáo từ một khảo sát nhỏ của nhóm nhằm xác định được rằng trong thực tế thì có những nhóm người dùng nào sẽ có nhu cầu tìm kiếm, hỏi đáp về pháp luật và cách thức để người dùng tìm được đáp án cho vấn đề đang cần tìm kiếm. Bên cạnh là các bài toán cần phải giải quyết để hoàn thành đồ án.

\textbf{Chương 3:} Công nghệ sử dụng

    Nội dung của chương 3 là chỉ ra các công nghệ được áp dụng và phối hợp với nhau để giải quyết được vấn đề cần phải giải quyết trong đề tài nghiên cứu.

\textbf{Chương 4:} Kiến trúc hệ thống

    Nội dung chương 4 là trình bày về chi tiết về hệ thống bao gồm
    \begin{itemize}
    	\item Mô hình hệ thống
    	\item Mô hình Usecase hệ thống
    	\item Kiến trúc phần Back-end: Trình bày chi tiết về quá trình thu thập dữ liệu pháp luật, Phương pháp xây dựng cơ sở dữ liệu và lưu trữ dữ liệu, Mô hình đào tạo dữ liệu phương pháp phân tích đưa ra được thông tin chuẩn xác từ mô hình. 
    	\item Kiến trúc phần Front-End: Trình bày về trình tự và cách để đưa dữ liệu được trả về ở phần Back-end hiển thị lên giao diện người dùng.
    \end{itemize}

\textbf{Chương 5:} Kết quả 
	Nội dung chương 5 là đưa ra kết quả đạt được sau từng bài toán cần phải giải quyết, kết quả về độ chính xác của hệ thống.

\textbf{Chương 6:} Kết luận và hướng phát triển
    Nội dung chương 6 là tóm tắt lại kết quả đạt được sau khi hoàn thành đề tài, ý nghĩa của đề tài và định hướng phát triển của đề tài trong tương lai
