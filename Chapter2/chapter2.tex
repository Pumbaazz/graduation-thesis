...
\begin{itemize}
	\item Thu thập giữ liệu câu hỏi và câu trả lời về pháp luật từ các trang web chuyên về Pháp luật.
	\item Mã hoá dữ liệu câu hỏi - Xử lý ngôn ngữ tự nhiên.
	\item So sánh tìm ra sự tương đồng giữa câu hỏi của người dùng và câu hỏi được lưu trữ trong hệ thống.
